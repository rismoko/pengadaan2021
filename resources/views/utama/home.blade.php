    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Ketentuan</h2>
          <p>Untuk dapat mengajukan barang dan jasa Peserta harus sesuai kualifikasi berikut ini</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Bagi kamu yang memiliki usaha sudah lebih lama atau sama dengan 3 tahun bisa mengajukan pengajuan</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p>Usaha kamu wajibberbadan hukum minimal CV dan sudah terdaftar sekurang-kurangnya 3 tahun</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Kamu dapat daftarkan usaha kamu agar dapat mengajukan dari setiap bidang yang dibutuhkan</p>
          </div>
