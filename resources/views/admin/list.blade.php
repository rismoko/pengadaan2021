                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$adm->alamat}}</td>
                      <td>
                        <button data-toggle="modal" data-target="#ubahModal" type="button" class="btn btn-secondary ubah" data-id_admin="{{$adm->id_admin}}"data-nama="{{$adm->nama}}"data-email="{{$adm->email}}"data-alamat="{{$adm->alamat}}"
